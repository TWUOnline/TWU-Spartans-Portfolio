		...
		<div class="sidebar">
			...
			<a class="nav-toggle hidden" title="<?php _e( 'Click to view the navigation', 'fukasawa' ); ?>" href="#">
				...
				<div class="credits">
					...
					<p><em><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php bloginfo( 'name' ); ?></em> 
					<a href="<?php echo esc_url( __( 'https://create.twu.ca/', 'fukasawa' ) ); ?>"><?php
				/* translators: %s: CMS name, i.e. WordPress. */
				printf( esc_html__( 'is powered by WordPress at the  %s', 'fukasawa' ), 'TWU Learning Commons' );
			?></a> 
			<?php
				/* translators: 1: Theme name, 2: Theme author. */
				printf( esc_html__( 'and displayed with the TWU Spartans Theme based on %1$s by %2$s.', 'fukasawa' ), 'Fukasawa', '<a href="http://www.andersnoren.se" rel="designer">Anders Nor&eacute;n</a>' );
			?></p>
